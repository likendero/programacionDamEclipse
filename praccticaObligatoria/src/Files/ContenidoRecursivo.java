...
/**
 * clase que pide un directorio por teclado
 * - en el caso que se trate de un archivo lo habisa
 * - si es un directorio muestra lo que hay en el
 */
public class ContenidoRecursivo {
     ...
     */
    public static void mostrarDirectorio(File archivo){

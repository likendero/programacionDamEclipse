...
public class Fecha {
	 ...
	 */
	public void valida() {
		//comprobacion que el a�o esta en rango
	...
	/**
	 * metodo que a traves de una entrada por teclado introduce dia,mes y a�o
	...
	/**
	 * metodo que indica si el a�o es bisiesto o no
	 ...
	 */
	public String corta() {
		//formateo para el para a�adir un cero en mes o dia si es necesario
		String salida="";
	...
	public int diasTranscurridos() {
		...
		//bucle que suma los dias de cada a�o
	 ...
	 * 
	 * @return nombreDia numeroDia de nombreMes de numeroA�o
	 */
	public String larga() {
	...
	/**
	 * metodo que devuelve el tiempo transcurrido entre dos fechas
	 * @param fecha1
	 * @param fecha2
	 * @return
	 */
	public static int numeroDias(Fecha fecha1,Fecha fecha2) {
		//variable para sumar los dias acumulados
		int diasAcumulados=0;
		//bucle que suma los dias de cada a�o
		for(int i=fecha1.getAnno(); i<fecha2.getAnno();i++) {
			if(i%400 == 0 || i%4 == 0 && i%100 != 0)diasAcumulados+=366;
			else diasAcumulados+=365;
		}
		//bucle que suma los dias de cada mes
		for(byte i= (byte) fecha1.getMes(); i<fecha2.getMes();i++) {
			diasAcumulados+=fecha2.diasMes(i);
		}
		diasAcumulados+=fecha2.getDia()-fecha1.getDia();
		return diasAcumulados;
	}
}
